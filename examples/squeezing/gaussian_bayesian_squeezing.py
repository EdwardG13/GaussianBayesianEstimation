...
if __name__ == '__main__':
    ...
    ax2.axhline(1, color='black', linewidth=lw_main)
    ...
    ax2.semilogx(prior_variance_list, ratio_homodyne,linestyle=':', linewidth=lw_main,color="#2E7CC5", label=f'Homodyne {phi_unicode}={phi_homodyne:.2f}')
